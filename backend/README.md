...
## Project Structure
    ...
    ├── ideapros_llc_radius_31965  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_radius_31965`
...
2. Clone this repo and `cd ideapros_llc_radius_31965`
